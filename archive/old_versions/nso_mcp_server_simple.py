#!/usr/bin/env python3
"""
NSO MCP Server - Simple Version
===============================

A simplified Model Context Protocol (MCP) server that exposes NSO network automation
capabilities. This version focuses on core functionality without complex LlamaIndex integration.
...
async def main():
    ...
    logger.info("🚀 Starting NSO MCP Server...")
