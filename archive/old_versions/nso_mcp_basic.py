#!/usr/bin/env python3
"""
NSO MCP Server - Basic Version for Cursor
=========================================

A basic MCP server that should work reliably with Cursor's MCP integration.
This version handles NSO connection issues gracefully.
