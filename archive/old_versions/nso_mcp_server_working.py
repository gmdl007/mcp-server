#!/usr/bin/env python3
"""
NSO MCP Server - Working Version
================================

A working Model Context Protocol (MCP) server that exposes NSO network automation
capabilities. This version uses a simpler approach for better compatibility.
