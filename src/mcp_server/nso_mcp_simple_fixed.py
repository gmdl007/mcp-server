#!/usr/bin/env python3
"""
NSO MCP Server - Simple Fixed Version for Cursor
===============================================

A simple MCP server that should work reliably with Cursor's MCP integration.
...
async def main():
    ...
    # Run the server with minimal capabilities
