#!/usr/bin/env python3
"""
Pure LlamaIndex NSO Client
Uses LlamaIndex tools directly without MCP protocol
"""
...
async def get_all_devices():
    """Get all devices using pure LlamaIndex tools."""
    print("🚀 Getting all devices using Pure LlamaIndex Tools")
    print("="*60)
    ...
    # Get all devices
    print("\n📱 Getting all devices:")
    response = await agent.run("Use show_all_devices to get all router names")
